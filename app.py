# app.py – Helsinki Taxi AI – Paasovellus

# Vaihe 5g – kaikki yhteen

# 

# Streamlit Cloud -yhteensopiva kaynistystiedosto.

# Aseta Streamlit Cloud Secrets:

# SUPABASE_URL, SUPABASE_ANON_KEY, OPENAI_API_KEY,

# ADMIN_PASSWORD, FINAVIA_APP_ID, FINAVIA_APP_KEY
...
# – Automaattinen lainausmerkkikorjaus kaikille src/-tiedostoille ——

def _fix_curly_quotes_in_src(root):
import pathlib
bad = {chr(0x201C): chr(34), chr(0x201D): chr(34),
chr(0x2018): chr(39), chr(0x2019): chr(39),
chr(0x2013): chr(45), chr(0x2014): chr(45)}
src_dir = pathlib.Path(root) / “src”
...
_log.getLogger(“taxiapp.app”).info(
“Lainausmerkkikorjaus: “ + str(fixed) + “ tiedostoa korjattu”
)

_fix_curly_quotes_in_src(_ROOT)
