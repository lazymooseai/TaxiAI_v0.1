...
# iPhonen Safari muuntaa lainausmerkit typografisiksi merkeiksi.

# Tama funktio korjaa ne kaikki ennen ensimmaista importtia.

def _fix_curly_quotes_in_src(root: str) -> None:
import pathlib
# Typografiset lainausmerkit ASCII-vastineilla (chr-muodossa)
bad_chars = {
...
f”Lainausmerkkikorjaus: {fixed} tiedostoa korjattu”
)
