...
Kova pakkanen (<-15°C)    → urgency 6, score +12
Helle (>28°C)             → urgency 4, score +8
...
def _build_signals(self, w: WeatherData) -> list[Signal]:
    ...
    if w.is_thunderstorm():
        ...
        reason = f"🌡️ KUUMUUS: {w.description()}"
